...
print 'For a hard kick (v = %g), the gravitational force is %g and the drag force is %g' % (V, F_g, F_d)

V = 10*speed_conversion #Soft kick velocity (m/s)
F_d = 0.5*C_D*rho*A*V**2
print 'For a soft kick (v = %g), the gravitational force is %g and the drag force is %g' % (V, F_g, F_d)
